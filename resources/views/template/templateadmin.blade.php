        ...
        <div class="container nav-wrap shadow">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/waka_dashboard"><i
                                class="bi bi-house-door-fill me-1"></i>Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/tambahPeriode"><i
                                class="bi bi-calendar2-plus"></i> Periode</a>
                    </li>
                    @if (Auth::user()->roles == 1)
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-list-task me-1"></i>Data
                                Ekskul</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/createEkskulAdmin">Tambah Ekskul</a></li>
                                <li><a class="dropdown-item" href="/daftarEkskul">List Ekskul</a></li>
                            </ul>
                        </li>
                    @endif
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            ...
                            Pengguna</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="/tambahPengguna">Tambah Pengguna</a></li>
                            <li><a class="dropdown-item" href="/listPenggunaAdmin">List Pengguna</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false"><img class="me-1"
                                style="border-radius: 10rem" src="{{ asset('ekskul') }}/asset/profile.png"
                                alt="" srcset="" />Hello, Waka</a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="{{ route('perbaruiAkun', Auth::user()->id) }}"><i
                                        class="bi bi-person-fill-gear me-1"></i>Kelola Akun</a>
                            </li>
                            <li>
