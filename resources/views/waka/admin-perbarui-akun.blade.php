                            ...
                            <div class="col-sm-5 text-center">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" id="floatingInput" placeholder=""
                                        name="inputPassword2" />
                                    <label for="floatingInput">Konfirmasi Password Baru <span
                                ...
                                <img class="img-fluid mt-3 shadow-sm" src="asset/profile.png" alt="" srcset=""
                                    style="border-radius: 100rem; width: 100%; height: auto" />
                                <div class="mt-3">
                                    <div class="btn-group-detail-admin">
                                        <button class="btn btn-primary" onclick="displayNotif()"><i
