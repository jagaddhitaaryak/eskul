                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group mb-3">
                                <form class="d-flex align-items-center flex-nowrap" action="/daftarEkskul">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('showEskulAdmin', $item->id) }}"><i
                                                                                class="bi bi-file-text-fill me-1"></i>Lihat</a>
                                                                    </li>
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('editEskulAdmin', $item->id) }}"><i
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <a href="{{ route('showEskulAdmin', $item->id) }}"
                                                    class="btn btn-primary  me-1"><i
                                                        class="bi bi-file-text-fill me-1"></i>Lihat</a>
                                                <a href="{{ route('editEskulAdmin', $item->id) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Apakah Kamu Yakin Ingin Menghapus
                                                    <strong>{{ $item->nama }}</strong> Dari List ?
                                                </div>
                                                <div class="modal-footer">
                                                    <form method="POST" action="{{ url('hapusEkskulWaka', $item->id) }}">
                                                        @csrf
                                                        <button type="submit" onclick=""
                                                            class="btn btn-primary" data-bs-dismiss="modal">Ya</button>
                                                    </form>
