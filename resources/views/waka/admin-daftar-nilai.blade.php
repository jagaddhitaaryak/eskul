                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="" class="btn btn-primary w-100 "><i class="bi bi-file-text-fill me-1"></i>Lihat</a>
    ...
    <div class="modal fade" id="modalHapus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">Apakah Kamu Yakin Ingin Menghapus <strong>Basket</strong> Dari List ?</div>
