              ...
              <div class="text-center">
                ...
                <form action="">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" placeholder="" name="inputNama" />
                  ...
                  <div class="form-floating mb-5">
                    ...
                    <label for="floatingInput">Password Pengguna</label>
                  </div>
                  <div class="row">
                    <div class="col-6">
                      <div class="text-start">
                        <a href="" class="btn text-primary"><strong>Kembali</strong></a>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="text-end">
