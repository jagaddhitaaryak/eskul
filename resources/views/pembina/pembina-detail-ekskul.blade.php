            ...
            <div class="admin-hp-wrap shadow" style="z-index: 10">
                <div class="row justify-content-center">
                    <div class="col-sm-4 text-center">
                        <img src="{{ asset('ekskul') }}/asset/{{ $ekskul->gambar }}" alt="" class="img-fluid mb-5" />
                    </div>
                    <div class="col-sm-10">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <h5>Nama Pembina</h5>
                            <p class="ms-3">{{ $pembina[0]->name }}</p>
                        </div>
                        <div class="mb-3">
                            <h5>Nama Ketua</h5>
                            <p class="ms-3">{{ $ketua[0]->name }}</p>
                        </div>
                        @php
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ url('editEskulPembina', $ekskul->id) }}" class="btn btn-primary btn-sm me-1"><i
                                    class="bi bi-pencil-fill me-1"></i>EDIT</a>
                            <a href="/list_ekskul_pembina" class="btn btn-secondary btn-sm"><i
